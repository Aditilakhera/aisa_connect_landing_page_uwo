    ...
    <div className="bg-white text-foreground selection:bg-primary selection:text-white">
      ...
      <div className="sticky-cta">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-primary text-white font-black text-sm active:scale-95 transition-transform shadow-lg shadow-primary/25"
        >
        ...
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-foreground text-white font-black text-sm active:scale-95 transition-transform"
        >
